    ...
    >
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
        <div>
          ...
          >
            <span className="mr-2">🏢</span> Business Supplies
          </motion.h1>
          <motion.p
          ...
          >
            Manage your business supplies and equipment
          </motion.p>
        </div>
      </div>
      ...
      <Card className="bg-gradient-to-br from-slate-950 to-slate-900 border-slate-800">
        <CardHeader>
          <CardTitle>Business Supplies Management</CardTitle>
          <CardDescription>
            Track and manage your business supplies inventory
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-gray-400">Business supplies management features coming soon...</p>
        </CardContent>
      </Card>
    </motion.div>
  );
